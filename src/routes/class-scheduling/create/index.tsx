...
export const ClassScheduleCreatePage = ({ children }: React.PropsWithChildren) => {
  ...
  useEffect(() => {
    if (courseId) {
      axios.get(`https://app.cmrsapp.site/course-management/api/courses/courseId/${courseId}`)
        .then((response) => {
  ...
  const handleAdd = (values: any) => {
    ...
    axios.post("https://app.cmrsapp.site/course-management/api/classSchedule/addClassSchedule", newClassSchedule,{
      headers: {
